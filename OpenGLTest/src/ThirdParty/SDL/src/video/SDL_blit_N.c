...
#define ONE_PIXEL_BLEND(condition, widthvar) \
        ...
        if (width > 0) {
            ...
            while (width) {
                ...
                vd = vec_ld(0, dstp);
                /* select the src and dest into vs */
...
static const struct blit_table normal_blit_1[] = {
    /* Default for 8-bit RGB src, never optimized */
...
static const struct blit_table normal_blit_2[] = {
    ...
    /* Default for 16-bit RGB src, used if no other blitter matches */
    {0, 0, 0, 0, 0, 0, 0, 0, BlitNtoN, 0}
};

static const struct blit_table normal_blit_3[] = {
    /* Default for 24-bit RGB src, never optimized */
    {0, 0, 0, 0, 0, 0, 0, 0, BlitNtoN, 0}
};
...
static const struct blit_table normal_blit_4[] = {
    ...
    /* Default for 32-bit RGB src, used if no other blitter matches */
    {0, 0, 0, 0, 0, 0, 0, 0, BlitNtoN, 0}
};
