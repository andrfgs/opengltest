                ...
                const double angle, const SDL_FPoint * center, const SDL_RendererFlip flip)
{
    ...
    /* Clone the src surface but use its pixel buffer directly.
     * The original src surface must be treated as read-only.
     */
     ...
     * or modulation is required. It's possible to use the src surface directly otherwise.
     */
        ...
        if (!retval) {
            ...
            if (blendmode != SDL_BLENDMODE_NONE || isOpaque) {
                ...
                if (!retval) {
                     ...
                     * by modulating the src colors with 0. Since the destination is all zeros, this
                     * will effectively set the destination alpha to the src alpha.
                     */
                    ...
                    if (!retval) {
                         ...
                         * to be created. This makes all src pixels opaque and the colors get copied correctly.
                         */
